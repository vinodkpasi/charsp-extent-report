...
{
    [TestClass]
    public class UnitTest2: DriverHooks
    {
        [ExtentTestMethod]
        public void Successful_Login_With_Valid_Credentials4()
        {
        ...
        [ExtentTestMethod]
        public void Successful_Login_With_Valid_Credentials5()
        {
        ...
        [ExtentTestMethod]
        public void Successful_Login_With_Valid_Credentials6()
        {
            ...
            Driver.FindElement(By.CssSelector("[type=submits]")).Click();
            ExtentTest.Log(Status.Pass, "Clicked on submit button");
